...
function generate_note($item)
{
	...
	*/
	...
	return '<div class="coderlol-note-outer"><div class="coderlol-note" style="'.$rotation.'"><div class="coderlol-note-inner" style="'.$curr_color_style.'"><label class="coderlol-note-title" style="font-size: '.$item->fontSize.'px;">'.$item->title.'</label><br><hr noshade size="1"></hr><div class="coderlol-note-inner-content" style="font-size: '.$item->fontSize.'px;">'.$item->content.'</div><br><br><div style="overflow: hidden; display: block;">'.$date_marker . $update_date . $new_marker . $important_marker .'</div></div></div></div>';
...
function generate_note_preview($note_atts, $date)
{
	...
	*/
	...
	return '<div class="coderlol-note-outer"><div class="coderlol-note" style="'.$rotation.'"><div class="coderlol-note-inner" style="'.$curr_color_style.'"><label class="coderlol-note-title" style="font-size: '.$note_atts['font_size'].'px;">'.$note_atts['title'].'</label><br><hr noshade size="1"></hr><div class="coderlol-note-inner-content" style="font-size: '.$note_atts['font_size'].'px;">'.$note_atts['content'].'</div><br><br><div style="overflow: hidden; display: block;">'.$date_marker . $update_date . $new_marker . $important_marker .'</div></div></div></div>';
